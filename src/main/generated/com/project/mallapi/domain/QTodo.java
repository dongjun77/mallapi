...
public class QTodo extends EntityPathBase<Todo> {
    ...
    private static final long serialVersionUID = -1052129370L;
    ...
    public final ListPath<TodoImage, QTodoImage> imageList = this.<TodoImage, QTodoImage>createList("imageList", TodoImage.class, QTodoImage.class, PathInits.DIRECT2);
